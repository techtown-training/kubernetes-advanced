...
The main program for the operator `cmd/manager/main.go` initializes and runs the Manager. By default this will be the namespace that the operator is running in.
...
Run the following commands to update the generated code for that resource type and generate the CRDs:
...
If you want to build your own Docker image (otherwise just skip this part), make sure to login to your Docker Hub account, and run the following commands:
